/*
 ...
 Source Schema         : clouddo

 Target Server Type    : MySQL
 Target Server Version : 50723
 File Encoding         : 65001

 Date: 10/11/2018 12:01:35
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 147 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文件上传' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_log` VALUES (80, 0, '', '登录', 2317, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-08-30 09:29:33');
INSERT INTO `sys_log` VALUES (81, 0, '', '登录', 23, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-08-30 09:34:41');
INSERT INTO `sys_log` VALUES (82, 1, 'admin', '获取用户列表', 20, 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', NULL, '127.0.0.1', '2018-08-30 09:39:33');
INSERT INTO `sys_log` VALUES (83, 0, '', '登录', 847, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-08-31 19:57:12');
INSERT INTO `sys_log` VALUES (84, 0, '', '登录', 26, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-08-31 19:57:49');
INSERT INTO `sys_log` VALUES (85, 0, '', '登录', 1713, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-10-23 16:46:29');
INSERT INTO `sys_log` VALUES (86, 0, '', '登录', 24, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-10-23 16:46:31');
INSERT INTO `sys_log` VALUES (87, 1, 'admin', '获取用户列表', 14, 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', NULL, '127.0.0.1', '2018-10-23 17:04:41');
INSERT INTO `sys_log` VALUES (88, 1, 'admin', '获取用户列表', 10, 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', NULL, '127.0.0.1', '2018-10-23 17:04:46');
INSERT INTO `sys_log` VALUES (89, 1, 'admin', '获取用户列表', 9, 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', NULL, '127.0.0.1', '2018-10-23 17:05:03');
INSERT INTO `sys_log` VALUES (90, 1, 'admin', '获取用户列表', 10, 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', NULL, '127.0.0.1', '2018-10-23 17:05:08');
INSERT INTO `sys_log` VALUES (91, 1, 'admin', '获取用户列表', 6, 'com.bootdo.clouddoadmin.controller.UserController.listByPage()', NULL, '127.0.0.1', '2018-10-23 17:05:45');
INSERT INTO `sys_log` VALUES (92, 0, '', '登录', 263349, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-10-23 17:10:43');
INSERT INTO `sys_log` VALUES (93, 0, '', '登录', 4252, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-10-23 17:10:51');
INSERT INTO `sys_log` VALUES (94, 0, '', '登录', 15, 'com.bootdo.clouddoadmin.controller.LoginController.login()', NULL, '127.0.0.1', '2018-10-23 17:11:02');
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3225 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` bigint(20) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 166 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户与角色对应关系' ROW_FORMAT = Dynamic;
